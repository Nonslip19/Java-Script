...
/* var str = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.";
var n = str.indexOf('simply'); //15
var n1 = str.indexOf("p"); //7
...
var str = "Bir berber bir berbere Bre berber gel birader biz beraber Berberistanda bir berber dükkanı açalım demiş "

// console.log(str.split("berber").length)

var strLower = str.toLocaleLowerCase()
var strSplit = strLower.split(" ")
var arananKelime = prompt("Aramak istediğiniz kelimeyi yazınız.")

var tekrar = []
for ( let i = 0; i < strSplit.length; i++){
    
    if (arananKelime == strSplit[i]){
        tekrar.push(i);  
